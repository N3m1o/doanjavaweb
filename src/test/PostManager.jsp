...
<script
	src="C:\Users\Admin42\eclipse-workspaceNew\test\ckeditor\ckeditor.js"></script>
			...
			<div class="modal-content">
				<form action="add" method="post">
					...
					<div class="modal-body">
						...
						<div class="form-group">
							<label>Display Image</label> <input name="image" type="text"
								class="form-control" required>
						</div>
						<div class="form-group">
							<label>Content</label>
							...
							<script type="text/javascript">
								var a = CKEDITOR.replace('content', {
									width : "700px",
									height : "400px"
								});
							</script>

				...
				<tbody>
					<c:forEach var="item" items="${newsList}">
						<tr>
							...
							<td>${item.newsId}</td>
							<td>${news.title}</td>
							<td><img src="${news.display_img}"></td>
							<td>${news.shortDescription}</td>
							<td>${news.content}</td>
							<td>
								<a href="/news/edit/${news.newsId}" class="edit" data-toggle="modal">
									<i class="material-icons" data-toggle="tooltip" title="Edit">&#xE254;</i></a> 
								<a href="/news/delete/${news.newsId}" class="delete" data-toggle="modal">
				...
				<form action="add" method="post">
					...
					<div class="modal-body">
						<div class="form-group">
							<label>Tiêu đề</label> <input name="title" type="text" class="form-control" required>
						</div>
						<div class="form-group">
							<label>Ảnh đại diện</label> <input name="image" type="text" class="form-control" required>
						</div>
						<div class="form-group">
						...
						<div class="form-group">
							<label>Thể loại</label> <select name="category" class="form-select" aria-label="Default select example" style = "width: 100px; margin-left: 30px;">
